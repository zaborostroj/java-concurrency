...
class SemaphoreBufferTest {
    @Test
    public void testBufferIsFIFO() {
        SemaphoreBuffer buffer = new SemaphoreBuffer(3);
    ...
    public void testBlockOnFull() {
        SemaphoreBuffer buffer = new SemaphoreBuffer(2);
    ...
    public void testSingleConsumerFIFO() {
        ...
        SemaphoreBuffer buffer = new SemaphoreBuffer(10);
    ...
    public void testMultiConsumerFIFO() {
        int messagesCount = 1000;
        SemaphoreBuffer buffer = new SemaphoreBuffer(50);
